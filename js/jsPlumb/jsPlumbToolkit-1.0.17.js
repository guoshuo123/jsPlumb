(function() {
    ...
    var d = function(a, b, c) {
        ...
        e = a.length,
        f = -1,
        g = 0; e > d;) if (f = parseInt((d + e) / 2), g = c(a[f], b), 0 > g) d = f + 1;
        else {
            if (! (g > 0)) return f;
            e = f
        }
    ...
    k = [null, [i[0], j[1]], [i[0], j[0]], [i[1], j[0]], [i[1], j[1]]],
    ...
    o = function(a, b, c, d, f, g, h, i, j, k) {
        ...
        v = function() {
            for (var g = 0; g < a.length; g++) {
                ...
                x = (a[g][2], c[a[g][1]]),
                y = n(t, x, d);
                h(a[g][1]) && e.intersects(p, y) && (l = m(p, y), o = f(a[g][1], t, l), u(w, t, o.left, o.top)),
                y = n(t, x, d);
            ...
            i && k(),
            s && q > r && (s = !1, r++, i ? window.setTimeout(v, j) : v())
        };
        return v(),
        t
    },
    ...
    b.Magnetizer = function(a) {
        ...
        F = function() {
            ...
            for (var a = 0; a < u.length; a++) {
                ...
                g = l(u[a]);
                s[g] = [c.left, c.top],
                E([[c.left, c.top], g, u[a]]),
                t[g] = f,
                b = Math.min(b, c.left),
                d = Math.min(d, c.top),
                e = Math.max(e, c.left + f[0]),
                h = Math.max(h, c.top + f[1])
            }
        },
        G = function() {
            if (u.length > 1) {
        ...
        this.executeAtEvent = function(b) {
            ...
            C && (i.style.left = b.pageX + "px", i.style.top = b.pageY + "px"),
            this.execute([e, f])
        },
...
function() {
    ...
    j = function(a) {
        for (var b = [], c = 0; c < a.length; c++) i(a[c]) ? b.push.apply(b, j(a[c])) : b[b.length] = a[c];
        return b
    },
    k = function(a, b) {
    ...
    n = function(a, b, c, d, e) {
        ...
        g.reapply = new Function("$data", i() + "for (var k = 0; k < this.e.length; k++) { with($data) { " + h() + " }} return out;"),
        c.bindings[a] = g,
        b.replace(/\$\{([^\}]*)\}/g,
        function(a, b, c, d) {
            g.e.push([a, b])
    ...
    u = function(a, b) {
        ...
        this.compile = function(a, b) {
            if (a.customTags[this.tag]) {
                for (var c = a.customTags[this.tag].getFunctionBody(this), d = 0; d < this.children.length; d++) this.children[d].precompile && (c += this.children[d].precompile(a)),
                c += this.children[d].compile(a),
                this.children[d].postcompile && (c += this.children[d].postcompile(a));
            ...
            if (this.remove !== !0) {
                ...
                for (var f in this.atts) if (this.atts.hasOwnProperty(f)) {
                    var g;
                    g = null != this.bindings[f] ? "_rotors.bind(data[0], '" + this.bindings[f].u + "');": "'" + this.atts[f] + "'",
                    e += "__a=" + g + ";if(__a!=null) e.setAttribute('" + f + "',__a || '');"
                }
            }
            for (var h = 0; h < this.children.length; h++) this.children[h].precompile && (e += this.children[h].precompile(a)),
            e += this.children[h].compile(a),
            this.children[h].postcompile && (e += this.children[h].postcompile(a));
            return this.remove === !0 || b || (e += "_le=_els.pop();"),
            e
        };
        var e = function(a, c) {
            b.each(c.split(";"),
    ...
    D(C.prototype, {
        ...
        each: function(a, b, c, d) {
            var e;
            if (i(a)) for (e = 0; e < a.length; e++) b(a[e], c, e, d);
        ...
        createFragment: function() {
            return this.isBrowser ? this.isOldIE() ? document.createElement("div") : document.createDocumentFragment() : new x
        },
        createTextNode: function(a) {
            return this.isBrowser ? document.createTextNode(a) : new z(a)
        },
        createElement: function(a) {
            return this.isBrowser ? document.createElement(a) : new y(a)
        },
        customElements: {
            "r-each": {
                ...
                compile: function(a) {
                    var b = function() {
                        ...
                        b += ";_rotors.popExecutionTrace(_eid, '" + this.uuid + "');";
            ...
            "r-tmpl": {
                ...
                parse: function(a, b, c, d) {
                    ...
                    for (var e = c(a.templateId), f = d.parse(e, c), g = 0; g < f.length; g++) f[g].context = a.context;
                    d.debug("nested ast", f),
                    a.children = f
                },
        ...
        registerTag: function(a, b) {
            this.customTags[a] = new d(this, a, b)
        },
        debugEnabled: !1,
        debug: function() {
        ...
        parse: function(a, b, c) {
            ...
            k = function(a, b) {
                d.length > 0 && i().children.push(a),
                b ? 0 == d.length && f.push(a) : d.push(a)
            },
            l = function(a) {
                k(a, !0)
            },
            o = function() {
                var a = d.pop();
                return 0 == d.length && f.push(a),
                a
            },
            p = function(a, b, c, e) {
                var f = new u(a, e),
                g = e.customElements[f.tag];
                return g && (g.parse(f, b, c, e, d), g.compile && (f.compile = g.compile), f.precompile = g.precompile, f.postcompile = g.postcompile, f.custom = !0, f.remove = g.remove, e.debug("  element is a custom element"), e.maybeDebug(f.remove, "  element's root should not appear in output")),
                f
            },
            q = [{
                re: g.commentRe,
            ...
            },
            {
                ...
                handler: function(a, b, c, d) {
                    ...
                    if (null == e || !e.remove) {
                        if (!j(b[1])) throw new TypeError("Unbalanced closing tag '" + b[1] + "'; opening tag was '" + o().tag + "'");
                        o()
                    }
                }
            },
            ...
            },
            {
                ...
                handler: function(a, b, c, d) {
                    ...
                    if (null != e && e.length > 0) {
                        ...
                        d);
                        l(f),
                        n("__element", e, f, null, d)
                    }
                }
            }];
            if (e(m(a).split(this.tokenizerRe),
            function(a, c) {
                for (var d = 0; d < q.length; d++) {
                    c = m(c);
                    var e = h(c, q[d].re);
                    if (e) {
                        q[d].handler(c, e, b, this);
                        break
                    }
                }
            }.bind(this)), f.length > 0 && c) for (var r in c) f[0][r] = c[r];
            return f
        },
        compile: function(a, b, c, d) {
            for (var e = "data=[data||{}];var frag=_rotors.createFragment(),_els=[],e,_le,__a,$value,$key,_eid = _rotors.newExecutionContext();_els.push(frag);",
            f = "return frag;",
            g = [], h = 0; h < a.length; h++) {
                var i = "";
    ...
    G = function(b, c) {
        c = c || "rotors";
        var d, e = (a.Rotors || a).newInstance(),
        f = {},
        ...
        var h = [{},
        null, d];
        for (var i in f) h[0][i] = String(e.precompileTemplate(f[i],
        function(a) {
            return f[a]
    ...
    "undefined" != typeof document ? (a.Rotors = {
        newInstance: E,
        precompile: G,
        data: g
    },
    a.RotorsInstance = C) : (a.newInstance = E, a.instanceClass = C, a.precompile = G, a.data = g)
}.call(this),
...
function() {
    ...
    b.requestAnimationFrame = c(a.requestAnimationFrame || a.webkitRequestAnimationFrame || a.mozRequestAnimationFrame || a.oRequestAnimationFrame || a.msRequestAnimationFrame ||
    function(b, c) {
        a.setTimeout(b, 10)
    },
    a);
    ...
    b.xml = {
        ...
        getChild: function(a, b) {
            for (var c = null,
            d = 0; d < a.childNodes.length; d++) if (1 == a.childNodes[d].nodeType && a.childNodes[d].nodeName == b) {
                c = a.childNodes[d];
                break
            }
            return c
...
function() {
    ...
    jsPlumb.Connection.prototype.animateOverlay = function(c, d) {
        ...
        B = function() {
            ...
            jsPlumb.addClass(v, b.nodeTraversing),
            e.addClass(b.edgeTraversing),
            window.setTimeout(function() {
                jsPlumb.removeClass(v, b.nodeTraversing),
                f.fire(a.nodeTraverseEnd, {
                    connection: e,
                    element: v
                }),
                A()
        ...
        C = function() {
            ...
            s ? (jsPlumb.addClass(w, b.nodeTraversing), window.setTimeout(function() {
                jsPlumb.removeClass(w, b.nodeTraversing),
                e.removeClass(b.edgeTraversing),
                f.fire(a.end, e)
            },
            n)) : (e.removeClass(b.edgeTraversing), f.fire(a.end, e))
        };
        return d.previous ? d.previous.bind(a.end, B) : B(),
        f
    }
} (),
...
function() {
    ...
    b.Selection = function(a) {
        ...
        r = function(a, b) {
            var d = c.removeWithFunction(n(a),
            function(b) {
                return b.id == a.id
            });
            return d && p(a, "Removed"),
            delete k[a.getFullId()],
            b && b(a, !1),
            [[], []]
        },
        s = function(a, b) {
...
function() {
    ...
    g = b.Vertex = b.Node = function(a, d, g) {
        ...
        this.addEdge = function(a) {
            j.push(a),
            a.source !== i && a.isDirected() || l++,
            a.target !== i && a.isDirected() || k++
        },
        this.deleteEdge = function(a) {
            for (var b = -1,
            c = 0; c < j.length; c++) if (j[c].getId() === a.getId()) {
                b = c;
                break
            }
        ...
        this.getIndegreeCentrality = function() {
            for (var a = 0,
            b = 0; b < m.length; b++) a += m[b].getIndegreeCentrality();
            return k + a
        },
        this.getOutdegreeCentrality = function() {
            for (var a = 0,
            b = 0; b < m.length; b++) a += m[b].getOutdegreeCentrality();
            return l + a
        },
        ...
        this.addPort = function(a, b) {
            var c = e(a, b, g),
            d = i.getPort(c);
            return null == d && (d = new h(a, b, i), m.push(d), o[d.id] = d),
            d
        },
    ...
    j = (b.Graph = function(a) {
        ...
        var s = function(a, d) {
            ...
            for (var h = null,
            i = null,
            j = 0; j < f.length - 1; j += 2) h = g(f[j]),
            i = h.getGraph(f[j + 1]);
            return i.getVertex(f[f.length - 1])
        };
        this.clear = function() {
            l.vertices.splice(0, l.vertices.length),
            d = 0,
            h = 0,
            c = {},
            f = {}
        ...
        this.deleteVertex = this.deleteNode = function(a) {
            ...
            if (b) {
                for (var e = -1,
                f = 0; f < l.vertices.length; f++) if (l.vertices[f].id === b.id) {
                    e = f;
                    break
                }
                e > -1 && l.vertices.splice(e, 1);
                for (var g = b.getEdges(), i = 0; i < g.length; i++) l.deleteEdge(g[i]);
                if (h -= g.length, b.getPorts) for (var j = b.getPorts(), k = 0; k < j.length; k++) l.deleteVertex(j[k]);
                delete c[b.id],
                d--
            }
        },
        ...
        this.getDiameter = function(a) {
            for (var b = 0,
            c = 0; c < l.vertices.length; c++) for (var d = 0; d < l.vertices.length; d++) if (d != c) {
                var e = n.compute({
                    graph: l,
                    source: l.vertices[c],
                    target: l.vertices[d]
        ...
        this.getCentrality = function(a) {
            return a = s(a),
            (a.getIndegreeCentrality() + a.getOutdegreeCentrality()) / (l.getVertexCount() - 1)
        },
        this.getDegreeCentrality = this.getCentrality,
        this.getIndegreeCentrality = function(a) {
            return a = s(a),
            a.getIndegreeCentrality() / (l.getVertexCount() - 1)
        },
        this.getOutdegreeCentrality = function(a) {
            return a = s(a),
            a.getOutdegreeCentrality() / (l.getVertexCount() - 1)
        },
        this.getCloseness = function(a) {
            return 1 / l.getFarness(a)
        },
        this.getFarness = function(a) {
            ...
            return c / (l.getVertexCount() - 1)
        },
        this.getBetweenness = function(a) {
            var b = l.getVertexCount(),
            c = (b - 1) * (b - 2) / 2,
            d = 0,
            e = 0,
            ...
            for (var h in g.paths) for (var i in g.paths[h]) if (h != i) {
                ...
                for (var n = 0; n < j.length; n++) {
                    var o = j[n].indexOf(a.id);
                    o > 0 && o < j[n].length - 1 && k++
                }
                d += k / j.length,
                e += k
            }
        ...
        this.inspect = function() {
            for (var a = "",
            b = 0; b < l.vertices.length; b++) a += l.vertices[b].inspect() + "\n";
            return a
        },
    ...
    k = function(a, b) {
        var c = b.getFullId(),
        d = a[c];
        return null == d && (c = b.getNode ? b.getNode().id: b.id, d = a[c]),
        null == d ? null: {
            p: d,
            id: c
        }
    ...
    l = function(a, b, c, d, e, f) {
        for (var g = [], h = d, i = k(b, h); null != i;) g.splice(0, 0, {
            vertex: h,
            cost: a[i.id],
            edge: c[i.id]
        }),
    ...
    m = {
        ...
        compute: function(a) {
            ...
            for (b = 0; f > b; b++) {
                ...
                var k = i.getEdges();
                for (d = 0; d < k.length; d++) k[d].source == i ? g[i.id][k[d].target.id] = k[d].getCost() : (g[k[d].source.id] || (g[k[d].source.id] = {},
                h[k[d].source.id] = {}), g[i.id][k[d].source.id] = k[d].getCost())
            }
    ...
    n = {
        compute: function(a) {
            ...
            if (null == c && (c = b.getVertex(a.sourceId)), null == d && (d = b.getVertex(a.targetId)), null == c || null == d) return k;
            var C = c,
            D = d;
            ...
            for (var E = new Array(b.vertices.length), F = 0, G = function(a, b, c, d) {
                ...
                if (d && (I == q(d) || !p && H.node.isChildOf && H.node.isChildOf(d)) && (k.path = l(g, h, i, d, q), k.pathDistance = k.path[k.path.length - 1].cost, !m)) break;
                E[H.index] = !0,
                F += 1,
                G(H, H.node.getAllEdges(),
                function(a) {
...
function() {
    ...
    a.jsPlumbToolkitInstance = function(g) {
        g = g || {};
        var h = g.idFunction || f,
        i = g.typeProperty || d,
        j = g.edgeTypeProperty || d,
        k = g.portTypeProperty || d,
        l = g.typeFunction ||
        function(a) {
            return a[i] || e
        },
        m = g.edgeIdFunction || h,
        n = g.edgeTypeFunction ||
        function(a) {
            return a[j] || e
        },
        o = g.portIdFunction || h,
        p = g.portTypeFunction ||
        function(a) {
            return a[k] || e
        },
        q = g.portExtractor,
        ...
        x = g.edgeFactory || v,
        y = g.portFactory || v,
        z = g.autoSave && g.saveUrl,
        A = g.saveUrl,
        B = g.onAutoSaveSuccess ||
        function() {},
        C = g.onAutoSaveError ||
        function() {},
        D = g.doNotUpdateOriginalData === !0,
        E = {
            portSeparator: g.portSeparator,
            defaultCost: g.defaultCost,
            defaultDirected: g.defaultDirected,
            enableSubgraphs: g.enableSubgraphs
        };
        b.EventGenerator.apply(this, arguments);
        var F = new jsPlumbGraph.Graph(E);
        z && new c.AutoSaver(this, A, B, C),
        new c.CatchAllEventHandler(this),
        ...
        var G, H = function() {
            return null == G && (G = new jsPlumbToolkit.Model(u || {})),
            G
        },
        I = function(a, b) {
            if (null == u) return ! 0;
        ...
        this.beforeConnect = g.beforeConnect || I,
        this.beforeMoveConnection = g.beforeMoveConnection || I,
        this.beforeStartConnect = g.beforeStartConnect ||
        function(a, b) {
            return {}
        },
        this.beforeDetach = g.beforeDetach ||
        function(a, b, c) {
            return ! 0
        },
        this.beforeStartDetach = g.beforeStartDetach ||
        function(a, b) {
            return ! 0
        },
        ...
        this.connect = function(a) {
            ...
            var b;
            if (!s) {
                var c = F.getVertex(a.source),
                d = F.getVertex(a.target),
                e = a.cost,
                f = a.directed;
                if (!c) {
                    if (a.doNotCreateMissingNodes) return;
                    c = F.addVertex(a.source),
                    r.fire("nodeAdded", {
                        data: {},
                        node: c
                    })
                ...
                if (!d) {
                    if (a.doNotCreateMissingNodes) return;
                    d = F.addVertex(a.target),
                    r.fire("nodeAdded", {
                        data: {},
                        node: d
                    })
                }
                var g = this.beforeStartConnect(c, n(a.data || {}));
                if (g) {
                    var h = a.data || {};
                    "object" == typeof g && jsPlumb.extend(h, g);
                    var i = this.beforeConnect(c, d, h);
                    i !== !1 && (b = F.addEdge({
                        source: c,
                        target: d,
                        cost: e,
        ...
        this.getNodeCount = function() {
            return F.getVertexCount()
        },
        this.getNodeAt = function(a) {
            return F.getVertexAt(a)
        },
        this.getNodes = function() {
            return F.getVertices()
        },
        this.eachNode = function(a) {
            for (var b = 0,
            c = F.getVertexCount(); c > b; b++) a(b, F.getVertexAt(b))
        },
        this.eachEdge = function(a) {
            for (var b = F.getEdges(), c = 0, d = b.length; d > c; c++) a(c, b[c])
        },
        this.getEdgeCount = function() {
            return F.getEdgeCount()
        },
        this.getNodeId = function(a) {
            return b.isObject(a) ? h(a) : a
        },
        this.getNodeType = function(a) {
            return l(a) || "default"
        },
        this.getEdgeId = function(a) {
            return b.isObject(a) ? m(a) : a
        },
        ...
        this.getType = function(a) {
            var b = "Node" === a.objectType ? l: "Port" === a.objectType ? p: n;
            return b(a.data) || "default"
        },
        this.setType = function(a, b) {
            var c = this.getType(a);
            if (c !== b) {
                var d = "Node" === a.objectType ? i: "Port" === a.objectType ? k: j,
        ...
        this.addNode = function(b, d, e) {
            ...
            if (null != g) {
                if (null != q) {
                    var i = q(g.data, g);
                    if (null != i) for (var j = 0; j < i.length; j++) g.addPort(i[j])
                }
                return O || D || a.jsPlumbToolkitIO.manage("addNode", M, N, g, h || F.getIdFunction(), r),
                e || r.fire("nodeAdded", {
                    data: b,
                    node: g,
                    eventInfo: d
        ...
        this.addNodes = function(a) {
            for (var b = 0; b < a.length; b++) r.addNode.apply(r, [a[b]]);
            return r
        },
        this.getNode = function(a) {
            return F.getVertex(a)
        },
        this.getEdge = function(a) {
            return F.getEdge(a)
        },
        this.exists = function(a) {
            for (var b = 0; b < arguments.length; b++) if (null == F.getVertex(arguments[b])) return ! 1;
            return ! 0
        },
        this.removeNode = function(b, c) {
            b = b.constructor == jsPlumbGraph.Vertex || b.constructor == jsPlumbGraph.Port ? b: F.getVertex(b);
            for (var d = b.getAllEdges() || [], e = 0; e < d.length; e++) r.removeEdge(d[e]);
            return F.deleteVertex(b.id),
            O || D || a.jsPlumbToolkitIO.manage("removeNode", M, N, b, h || F.getIdFunction(), r),
            c || r.fire("nodeRemoved", {
                node: b,
                nodeId: b.id,
                edges: d
            }),
        ...
        this.addEdge = function(b, c, d) {
            var e = F.addEdge(b, m);
            return O || D || a.jsPlumbToolkitIO.manage("addEdge", M, N, e, m || F.getIdFunction(), r),
            d || r.fire("edgeAdded", {
                edge: e,
                source: c,
                geometry: b.geometry
        ...
        this.removeEdge = function(b, c) {
            return b = F.getEdge(b),
            null != b && (F.deleteEdge(b), O || D || a.jsPlumbToolkitIO.manage("removeEdge", M, N, b, m || F.getIdFunction(), r), r.fire("edgeRemoved", {
                edge: b,
                source: c
            },
            null)),
        ...
        this.setTarget = function(a, b, c) {
            var d = F.setTarget.apply(F, arguments);
            return d.success === !1 || c || r.fire("edgeTarget", d),
            d
        },
        this.setSource = function(a, b, c) {
            var d = F.setSource.apply(F, arguments);
            return d.success === !1 || c || r.fire("edgeSource", d),
            d
        },
        this.addNewPort = function(b, c, d, e) {
            ...
            function(c) {
                ...
                f = b.addPort(d);
                f.data = c,
                O || D || a.jsPlumbToolkitIO.manage("addPort", M, N, {
                    node: b,
                    port: f
                },
                o || F.getIdFunction(), r),
        ...
        this.addPort = function(b, c, d) {
            var e = b.addPort(c, o);
            return O || D || a.jsPlumbToolkitIO.manage("addPort", M, N, {
                node: b,
                port: e
            },
            o || F.getIdFunction(), r),
        ...
        this.removePort = function(a, b, c) {
            var d = !1;
            a = a.constructor == jsPlumbGraph.Vertex || a.constructor == jsPlumbGraph.Port ? a: F.getVertex(a);
            var e = a.getPort(b);
            if (e) {
                var f = e.getAllEdges();
                if (d = a.removePort(e), d && !c) {
                    ...
                    null);
                    for (var g = 0; g < f.length; g++) r.removeEdge(f[g])
                }
            }
            return d
        },
        this.remove = function(a) {
            if (null != a) {
                var b = r.getObjectInfo(a);
                r.setSuspendRendering(!0);
                try {
                    if (!b.obj || "Node" != b.type && "Edge" != b.type) {
                        for (; a.getNodeCount() > 0;) r.removeNode(a.get(0));
                        for (; a.getEdgeCount() > 0;) r.removeEdge(a.getEdge(0))
                    } else r["remove" + b.type](b.obj)
                } finally {
                    r.setSuspendRendering(!1, !0)
                }
            }
        },
        this.setSuspendRendering = function(a, b) {
            for (var c in W) W[c].setSuspendRendering(a, b)
        },
        ...
        var K = this.findGraphObject = function(a) {
            return null == a ? null: "*" === a ? F: a.constructor == jsPlumbGraph.Vertex || a.constructor == jsPlumbGraph.Port ? a: b.isString(a) || b.isObject(a) ? F.getVertex(a) : null
        },
        L = function(a, b, c) {
            a = a || {};
            var d = [],
            ...
            g = function(d, e, g, h) {
                if (null != d) for (var i = d[b]({
                    ...
                    var k = e && d == F || i[j].source == d || c && i[j].source.constructor == jsPlumbGraph.Port && i[j].source.getNode() == d,
                    l = g && d == F || i[j].target == d || c && i[j].target.constructor == jsPlumbGraph.Port && i[j].target.getNode() == d; (e && k || g && l || h && (k || l)) && f(i[j])
                }
            };
            return g(K(a.source), !0, !1, !1),
            g(K(a.target), !1, !0, !1),
            g(K(a.element), !1, !1, !0),
            d
        };
        this.getEdges = function(a) {
            return L(a, "getEdges", !1)
        },
        this.getAllEdges = function() {
            return F.getAllEdges()
        },
        ...
        var M, N, O, P = function(b, d, e) {
            ...
            var m = function(b) {
                ...
                O = !0,
                r.fire(d),
                a.jsPlumbToolkitIO.parse(f, b, r, k),
                V(e),
                j && j(r, b),
                r.fire("graphChanged")
            };
        ...
        this.load = function(a) {
            return P(a, "dataLoadStart", "dataLoadEnd")
        },
        this.append = function(a) {
            return P(a, "dataAppendStart", "dataAppendEnd")
        },
        ...
        this.exportData = function(b) {
            return b = b || {},
            a.jsPlumbToolkitIO.exportData(b.type || "json", r, b.parameters)
        };
        var Q = function(a) {
        ...
        R = Q(function(a) {
            r.fire("selectionCleared", {
                selection: a
            })
        });
        g.maxSelectedNodes && R.setMaxNodes(g.maxSelectedNodes),
        g.maxSelectedEdges && R.setMaxEdges(g.maxSelectedEdges),
        g.selectionCapacityPolicy && R.setCapacityPolicy(g.selectionCapacityPolicy);
        ...
        var T = function(a, b, c, d) {
            for (var e = a.getAllEdges(), f = 0, g = e.length; g > f; f++) if (e[f].source === a || e[f].getNode && e[f].getNode() === a) {
                var h = e[f].target,
                i = h.getFullId();
                d[i] || (b.append(h), c && b.append(e[f]), d[i] = !0, T(h, b, c, d))
            }
        };
        this.selectDescendants = function(a, b, c) {
            var d = r.getObjectInfo(a),
            e = Q();
        ...
        var U = function(a, b) {
            for (var c = 0; c < b.length; c++) r.fire(a, {
                obj: b[c],
                selection: R
            })
        };
        ...
        if (this.render = function(b, c) {
            var d = jsPlumb.extend({},
            c || {});
            jsPlumb.extend(d, b),
            d.toolkit = r,
            null != b.selection && (b.selection.constructor === jsPlumbToolkitUtil.Selection ? d.toolkit = b.selection: d.toolkit = new jsPlumbToolkitUtil.Selection({
        ...
        this.getObjectInfo = function(a, b) {
            ...
            e = function(a) {
                var b = {};
                for (var c in W) b[c] = [W[c], W[c].getRenderedElement(a)];
                return b
            };
            if (null != a) {
                ...
                if (null != f && f.jtk) c.el = f,
                c.obj = f.jtk.port || f.jtk.node;
                ...
                null == b && (c.els = e(c.obj)),
                null != c.obj && (c.id = c.obj.id, c.type = c.obj.objectType)
            }
            return c
        },
        g.data) {
            var X = g.dataType || "json";
            r.load({
                data: g.data,
                type: X
            })
    ...
    a.jsPlumbToolkit.ready = jsPlumb.ready,
    a.jsPlumbToolkit.Renderers = {},
    a.jsPlumbToolkit.Widgets = {},
    a.jsPlumbToolkit.newInstance = function(b) {
...
function() {
    ...
    c.Path = function(a, b) {
        ...
        g = [], h = {},
        i = 0; i < c.path.length; i++) g.push(c.path[i].vertex),
        h[a.getNodeId(c.path[i].vertex)] = [c.path[i].vertex, i];
        this.getNodes = function() {
            return g
        },
        this.getNode = function(a) {
...
function() {
    ...
    var d = function(a, b, c) {
        ...
        for (var j = 0; j < e.length; j++) {
            ...
            e[j].geometry && (k.geometry = e[j].geometry),
            b.addEdge(k)
        }
    },
    e = function(a, b) {
    ...
    b.managers = {
        json: {
            ...
            addPort: function(a, b, c) {
                ...
                var d = jsPlumb.extend({},
                b.port.data || {});
                d.id = b.port.getFullId(),
                a.ports.push(d)
            },
            removePort: function(a, b, d) {
                var e = b.port.getFullId();
                c.removeWithFunction(a.ports,
                function(a) {
                    return a.id == e
                })
            }
...
function() {
    ...
    e = function(a) {
        ...
        d = -(1 / 0),
        e = -(1 / 0);
        for (var f in a) b = Math.min(b, a[f][0]),
        d = Math.max(d, a[f][0]),
        c = Math.min(c, a[f][1]),
        e = Math.max(e, a[f][1]);
    ...
    c.AbstractLayout = function(b) {
        ...
        g = function() {
            ...
            a.jsPlumb.extend(b, i || {}),
            i = b
        },
        h = b.adapter,
        i = b.parameters || {},
        j = b.getElementForNode,
        k = new Magnetizer({
        ...
        this.decorators = f(b.decorators),
        ...
        this.nodeRemoved = function(a) {
            ...
            k.removeElement(b.node)
        };
        var C = function(a, b) {
            var c = v[a];
            return c || (b = b || j(a), null != b ? (c = m.getSize(b), v[a] = c) : c = [0, 0]),
            c
        },
        D = function(a, b, c, d) {
            var e = o[a];
        ...
        F = this.setPosition = function(a, b, d, e) {
            var f = o[a];
            f ? (f[0] = parseFloat(b), f[1] = parseFloat(d)) : (f = o[a] = [parseFloat(b), parseFloat(d)], p.push([f, a])),
            E(f),
            e && c._nodeMoved && c._nodeMoved(a, b, d)
        },
        G = function(a, b, c) {
            b = b || 10,
            c = c || 10;
        ...
        I = function(a, b) {
            ...
            if (null != d) {
                var e = o[a];
                return c.adapter.setAbsolutePosition(d, e, b),
                M[a] = [e[0], e[1]],
                e.concat(C(a))
            }
            return null
        ...
        var O = function(a) {
            if (null != n) {
                g(),
                k.setElements(h.getNodes()),
                this.begin && this.begin(n, i);
                for (var b = function() {
                    J(function() {
                        l && c.magnetize(),
                        c.end && c.end(n, i),
    ...
    var g = c.AbsoluteBackedLayout = function(a) {
        ...
        return this.begin = function(a, c) {
            for (var d = b.adapter.getNodeCount(), f = 0; d > f; f++) {
                var g = b.adapter.getNodeAt(f),
                h = a.getNodeId(g.data),
                i = b.getPosition(h, null, null, !0);
                null == i && (i = e(g, c)),
                this.setPosition(h, i[0], i[1], !0)
            }
        },
    ...
    var h = c.AbstractHierarchicalLayout = function(a) {
        ...
        return b.begin = function(b, c) {
            ...
            c.getRootNode = c.getRootNode ||
            function(a) {
                return d.adapter.getNodeCount() > 0 ? d.adapter.getNodeAt(0) : void 0
            },
            c.getChildEdges = c.getChildEdges ||
            function(a, b) {
                return d.toolkit.getAllEdgesFor(a,
                function(b) {
                    return b.source === a
                })
            },
            c.rootNode = c.getRootNode(b),
            c.rootNode ? c.root = c.rootNode.id: d.setDone(!0)
        },
        d
    };
...
function() {
    ...
    c.Circular = function(a) {
        ...
        this.step = function(a, c) {
            ...
            j = 2 * Math.PI / d,
            k = -Math.PI / 2;
            for (e = 0; d > e; e++) f = b.adapter.getNodeAt(e),
            b.setPosition(f.id, g + Math.sin(k) * i, h + Math.cos(k) * i, !0),
            k += j;
            ...
            for (i = w / 2 / Math.sin(j / 2), e = 0; d > e; e++) f = b.adapter.getNodeAt(e),
            b.setPosition(f.id, g + Math.sin(k) * i, h + Math.cos(k) * i, !0),
            k += j;
            b.setDone(!0)
        }
    ...
    c.Hierarchical = function(a) {
        ...
        t = function(a) {
            if (a.size > 0) {
                ...
                for (var j = a.loc,
                k = 0; k < a.nodes.length; k++) a.nodes[k].loc = j,
                j += a.nodes[k].size,
                j += h[e];
                f > 0 && v(a),
                s(a, a.depth)
        ...
        u = function(a) {
            ...
            e = d - a.parent.size / 2,
            f = e - a.parent.loc;
            if (a.parent.loc = e, !a.parent.root) for (var g = a.parent.childGroup,
            h = a.parent.childGroupIndex + 1; h < g.nodes.length; h++) g.nodes[h].loc += f
        },
        v = function(a) {
            for (var b = a; null != b;) u(b),
            ...
            if (!i[a.node.id]) {
                ...
                for (c = 0; c < d.length; c++) {
                    ...
                    if (l = k.toolkit.getNode(l), null != l && l !== a.node) {
                        var m = k.getSize(p(l)),
                        n = r(l, m, b + 1, a, f);
                        n.childGroupIndex = f.nodes.length,
                        f.nodes.push(n),
                        f.size += m[e] + h[e],
                        g.push(n)
                    }
        ...
        this.step = function(a, b) {
            ...
            o = 0; o < n.length; o++) {
                n[o].otherAxis = i;
                for (var q = 0; q < n[o].nodes.length; q++) f = 0 == e ? n[o].nodes[q].loc: j(n[o].nodes[q], i),
                n[o].nodes[q].parent && k.getPosition(p(n[o].nodes[q].parent.node)),
                g = 1 == e ? n[o].nodes[q].loc: j(n[o].nodes[q], i),
                k.setPosition(p(n[o].nodes[q].node), f, g, !0);
                n[o].otherAxisSize = l[o] + h[0 == e ? 1 : 0],
                i += n[o].otherAxisSize
            }
            k.setDone(!0)
        },
    ...
    c.Spring = function(a) {
        ...
        s = function(a, b) {
            ...
            if (!a.locked || !c.locked) {
                ...
                var i = (g - e.k * e.k) / e.k; (void 0 == b.weight || b.weight < 1) && (b.weight = 1),
        ...
        this.begin = function(a, c) {
            h = 0,
            d = b.adapter.getNodeCount()
        },
        this.step = function(a, c) {
            var f, i = [],
            j = function(a) {
                return i[a] ? i[a] : function() {
                    return i[a] = p(b.adapter.getNodeAt(a)),
                    i[a]
                } ()
            };
            for (o = 0, f = 0; d > f; f++) {
            ...
            h++,
            (0 == o || h >= e.iterations) && (t(), b.setDone(!0))
        },
        this.end = function() {
...
function() {
    ...
    b.createElement = function(a, b) {
        ...
        a.units || i.px;
        return null != a.top && (c.style.top = a.top + i.px),
        null != a.left && (c.style.left = a.left + i.px),
        null != a.right && (c.style.right = a.right + i.px),
        null != a.bottom && (c.style.bottom = a.bottom + i.px),
        c.style.width = a.width,
        c.style.height = a.height,
        c.style.position = a.position || i.absolute,
        a.id && c.setAttribute(i.id, a.id),
        a.display && (c.style.display = a.display),
        a.clazz && (c.className = a.clazz),
        null != b && jsPlumb.appendElement(c, b),
        c
    };
    var k = function(a, b) {
    ...
    q = b.AbstractRenderer = function(b) {
        ...
        s = b.elementsDroppable === !0,
        t = !1,
        u = b.refreshAutomatically !== !1,
        v = b.templateRenderer ? e.isString(b.templateRenderer) ? m[b.templateRenderer] : {
        ...
        y = b.modelLeftAttribute || "left",
        z = b.modelTopAttribute || "top",
        A = e.merge(b.jsPlumb || {}),
        B = b.jsPlumbInstance || jsPlumb.getInstance(A),
        C = B.getId(q);
        B.bind("beforeDrop",
        function(a) {
            var b = a.connection,
        ...
        this.bind = function(a, b) { - 1 == D.indexOf(a) ? F(a, b) : E(a, b)
        },
        b.events) for (var G in b.events) this.bind(G, b.events[G]);
        if (b.interceptors) for (var H in b.interceptors) this.bind(H, b.interceptors[H]);
        var I = !1;
        F(j.connection,
        function(a) {
            if (null == a.connection.edge) {
                I = !0,
                a.sourceEndpoint.getParameter("nodeId") || a.sourceEndpoint.setParameter("nodeId", K[a.sourceEndpoint.elementId].id),
                a.targetEndpoint.getParameter("nodeId") || a.targetEndpoint.setParameter("nodeId", K[a.targetEndpoint.elementId].id);
                var b = a.sourceEndpoint.getParameter("portType"),
                c = _.getPortDefinition(b),
                ...
                o = l.getEdgeFactory()(d, a.connection.getData() || {},
                function(b) {
                    n.edge = l.addEdge({
                        source: k,
                        target: m,
                    ...
                    i),
                    P[n.edge.getId()] = a.connection,
                    a.connection.edge = n.edge,
                    T(d, n.edge, a.connection),
                    n.addedByMouse = !0,
                    i.fire(j.edgeAdded, n)
                });
                o === !1 && B.detach(a.connection),
                I = !1
            }
        }),
        F(j.connectionMoved,
        ...
        F(j.connectionDetached,
        function(a) {
            I = !0,
            l.removeEdge(a.connection.edge),
            I = !1;
        ...
        O = function(a) {
            var b = M.indexOf(a); - 1 != b && M.splice(b, 1)
        };
        this.getNodeCount = function() {
            return M.length
        },
        ...
        R = function(a) {
            for (var b = [], c = 0; c < a.length; c++) b.push(P[a[c].getId()]);
            return b
        },
        S = function(a, b, c, d) {
            d.bind(a,
        ...
        T = function(a, b, c) {
            if (!c.getParameter("edge")) {
                ...
                if (d && d.events) for (var e in d.events) S(e, d.events[e], b, c)
            }
        },
        U = function(a, b) {
        ...
        var V = function(a, b) {
            if (t) X.push([a, b]);
                ...
                if (null != c) {
                    ...
                    d.unshift(a),
                    B.addToPosse.apply(B, d)
                }
            }
        },
        W = function() {
            for (var a = 0; a < X.length; a++) V.apply(this, X[a])
        },
        X = [];
        if (this.bindToolkitEvents !== !1) {
            var Y = function() {
                X.length = 0,
                B.setSuspendDrawing(!0),
                this.setSuspendRendering(!0)
            }.bind(this);
            l.bind(j.dataLoadStart, Y),
            l.bind(j.dataAppendStart, Y),
            l.bind(j.dataLoadEnd,
            function() {
                this.setSuspendRendering(!1),
                W(),
                i.relayout(),
                B.setSuspendDrawing(!1, !0),
                p && i.fire(j.dataLoadEnd)
            }.bind(this)),
            l.bind(j.dataAppendEnd,
            function() {
                this.setSuspendRendering(!1),
                W(),
                i.refresh(),
                B.setSuspendDrawing(!1, !0),
                p && i.fire(j.dataAppendEnd)
            }.bind(this));
            var Z = function(a, b) {
                var c = J[a.id];
                if (null == c) {
                    var d = _.getNodeDefinition(l.getNodeType(a.data));
                    if (d.ignore === !0) return ! 1;
                    if (c = ea(a, a.data, a), !c) throw new Error("Cannot render node");
                    var e = B.getId(c);
                    J[a.id] = c,
                    K[e] = a,
                    N(a),
                    ...
                    i.append(c, e, b ? b.position: null),
                    V(c, a),
                    ka(c, a, a.id);
                    var f = {
                        node: a,
                    ...
                    i.getLayout().nodeAdded(f, b),
                    i.fire(j.nodeAdded, f)
                }
                return c
            };
            l.bind(j.nodeAdded,
            ...
            var $ = function(a, b) {
                return function() {
                    ...
                    b && (c.geometry = b),
                    l.isDebugEnabled() && console.log("Renderer", "adding edge with params", c);
                    var d = B.connect(c);
                    d.edge = a,
                    P[a.getId()] = d,
                    T(c.type, a, d),
            ...
            l.bind("graphCleared",
            function() {
                for (var a in J) B.remove(J[a], !0);
                p && p.clear(),
                B.setSuspendEvents(!0),
                B.batch(B.deleteEveryEndpoint, !0),
                B.setSuspendEvents(!1),
                M.length = 0,
                P = {},
                J = {},
                K = {},
            ...
            function(a) {
                var b = J[a.node.id],
                c = fa(a.port, a.data, a.node);
                L[a.node.id + l.getGraph().getPortSeparator() + a.port.id] = c,
                ka(jsPlumb.getElement(c), a.node, a.node.id),
                i.fire(j.portAdded, {
                    node: a.node,
                    nodeEl: b,
                    port: a.port,
                ...
                B.recalculateOffsets(b),
                i.refresh(!0)
            }),
            l.bind(j.portRemoved,
            function(a) {
                var b = J[a.node.id],
            ...
            l.bind(j.portUpdated,
            function(a) {
                var b = L[a.port.getFullId()];
                b && ("undefined" != typeof Rotors && o.update(b, a.port.data), i.repaint(J[a.node.id]))
            }),
            l.bind(j.nodeUpdated,
            function(a) {
                var b = J[a.node.getFullId()];
                if (b) {
                    "undefined" != typeof b._rotors && o.update(b, a.node.data),
                    ka(b, a.node, a.node.id);
                    var c = x(a.node);
                    if (null != c) {
                        var d = jsPlumbUtil.isArray(c) ? c: [c];
                        d.unshift(b),
                        B.setPosse.apply(B, d)
                    } else B.removeFromAllPosses(b);
                    i.repaint(b)
                }
            })
        }
        ...
        this.deactivateState = function(a, b) {
            var c = _.getState(a);
            c && (b = ba(b), c.deactivate(b, i, l), jsPlumbUtil.removeWithFunction(aa,
            function(a) {
                return a == c
            }))
        },
        this.resetState = function() {
            for (var a = 0; a < aa.length; a++) aa[a].deactivate(l, i, l);
            aa.length = 0
        };
        var ca = function(a) {
            var b = l.getEdgeType(a.data),
            c = {
                type: b,
                connectionType: b,
                data: a.data,
            ...
            var e = function(b) {
                if (a[b].getNode) {
                    ...
                    e = a[b].getFullId(),
                    f = ha[e] || ia[b][e];
                    null != f ? c[b] = f: c[b] = L[e],
                    null == c[b] && (c[b] = J[l.getNodeId(d.data)])
                } else c[b] = J[l.getNodeId(a[b].data)]
            };
            return e("source"),
            e("target"),
            c
        ...
        da = function(a, b, c, d, e, f, g, h) {
            return function(i, j, k) {
                ...
                if (w) {
                    ...
                    jsPlumb.extend(t, j);
                    var u = {};
                    for (m in t) t.hasOwnProperty(m) && null != t[m] && (t[m].constructor == Function ? u[m] = t[m](j) : u[m] = t[m]);
                    t = u
                }
                if (q) {
                ...
                o = B.getElement(o),
                o.setAttribute(h, n),
                jsPlumb.addClass(o, g),
                o.jtk = o.jtk || {},
                o.jtk[a] = i,
                o.jtk.node = k,
                f && r && na.makeDraggable && na.makeDraggable(o, q.dragOptions),
                s && na.makeDroppable && na.makeDroppable(o, q.dropOptions);
                var y = function(a) {
                    B.on(o, a,
                    function(b) {
                        q.events[a]({
                ...
                if (q && q.events) for (m in q.events) y(m);
                return o
            }
        },
        ea = da("node", l.getNodeId, l.getNodeType, "getNodeDefinition", k, !0, h.NODE, f.NODE),
        fa = da("port", l.getPortId, l.getPortType, "getPortDefinition", k, !1, h.PORT, f.PORT);
        this.initialize = function() {
            ...
            if (l.setSuspendGraph(!0), B.setSuspendDrawing(!0), b.jsPlumbInstance) {
                ...
                for (var e in c) {
                    var f = c[e].el;
                    J[f.jtk.node.id] = f,
                    K[b.jsPlumbInstance.getId(f)] = f.jtk.node
                }
                na.doImport && na.doImport(J, P)
            } else {
                for (a = 0; a < l.getNodeCount(); a++) c = l.getNodeAt(a),
                Z(c);
                for (a = 0; a < l.getNodeCount(); a++) if (c = l.getNodeAt(a), J[c.id]) for (var g = l.getAllEdgesFor(c), h = 0; h < g.length; h++) if (g[h].source == c || g[h].source.getNode && g[h].source.getNode() == c) {
        ...
        var ga = function(b) {
            ...
            b);
            if (c.jsPlumbToolkit = l, c.adapter = i, !a.jsPlumbToolkit.Layouts[c.type]) throw "no such layout [" + c.type + "]";
        ...
        ja = function(a, b, c) {
            ...
            h = a.getAttribute("scope") || B.getDefaultScope(),
            j = l.getNodeType(b),
            k = _.getNodeDefinition(j),
            m = _.getPortDefinition(f, k),
            n = _.getPortDefinition(g, k),
            o = e.merge(n, m),
            p = null == o ? {}: d.populate(o, b.data),
            q = function(a) {
                return function(d) {
                    var e = b.getPort(f),
                    h = [{
            ...
            s = p.edgeType || a.getAttribute("edge-type") || "default",
            t = {
            ...
            if (p.connectionType = s, p.portId = f, p.portType = g, p.scope = h, p.parameters = p.parameters || {},
            p.parameters.portId = f, p.parameters.portType = g, p.parameters.edgeType = s, p.parameters.scope = h, p.parameters.nodeId = c, p.events = {},
            o.events) for (v in o.events) p.events[v] = q(o.events[v]);
            if (o.interceptors) for (v in o.interceptors) p[v] = r(o.interceptors[v]);
        ...
        ka = function(a, b, c, d) {
            ...
            if (a.childNodes) {
                var f, h = [];
                for (e = 0; e < a.childNodes.length; e++) if (3 != a.childNodes[e].nodeType && 8 != a.childNodes[e].nodeType) {
                    if (a.childNodes[e].tagName.toUpperCase() == g.PORT && null == a.childNodes[e].getAttribute("jtk-processed")) {
                        ...
                        "undefined" != typeof Rotors && o.onUpdate(a,
                        function(a, b) {})
                    }
                    if (a.childNodes[e].tagName.toUpperCase() == g.SOURCE && null == a.childNodes[e].getAttribute("jtk-processed")) {
                        ...
                        if (null != f.portId && (ia.source[c + "." + f.portId] = a, a.jtk = a.jtk || {},
                        a.jtk.port = l.addPort(b, {
                            id: f.portId
                        },
                        !0)), m) {
                            var n = k.getAttribute("filter-exclude"),
                            p = "true" === n;
                            f.filter = m,
                            f.filterExclude = p
                        }
                        delete f.uniqueEndpoint,
                        f.extract = {};
                        ...
                        u > t && (s = a._katavorioDrop[a._katavorioDrop.length - 1]),
                        a.childNodes[e].setAttribute("jtk-processed", !0),
                        "undefined" != typeof Rotors && o.onUpdate(a,
                        function(a, d) {
                    ...
                    if (a.childNodes[e].tagName.toUpperCase() == g.TARGET && null == a.childNodes[e].getAttribute("jtk-processed")) {
                        f = ja(a.childNodes[e], b, c),
                        0 != d && (ia.target[c + "." + f.portId] = a, a.jtk = a.jtk || {},
                        a.jtk.port = l.addPort(b, {
                            id: f.portId
                        },
                        !0)),
                ...
                for (e = 0; e < h.length; e++) h[e].parentNode.removeChild(h[e])
            }
        };
        this.setLayout(b.layout, !0),
        this.storePositionsInModel = function(a) {
            ...
            for (var e in d) {
                var f = l.getNode(e);
                Rotors.data(f.data, b, d[e][0]),
                Rotors.data(f.data, c, d[e][1])
            }
        },
        this.storePositionInModel = function(a) {
            ...
            e = p.getPosition(b),
            f = l.getNode(b);
            return f && (Rotors.data(f.data, c, e[0]), Rotors.data(f.data, d, e[1])),
            e
        };
        var la = function(a, b, c, d, e, f, g) {
            return a = a || ma(b),
            a && (p.setPosition(a.id, c, d), e || (B.setAbsolutePosition(a.el, [c, d], f, g), B.revalidate(a.el))),
            a
        };
        ...
        this.setVisible = function(a, b, c) {
            if (null != a) {
                var d = function(a) {
                    var d = Q(a);
                    d && d.setVisible(b),
                    c || (d.endpoints[0].setVisible(b), d.endpoints[1].setVisible(b))
                },
                e = function(a, e) {
        ...
        var ma = function(a) {
            return a instanceof B.getDefaultConnectionType() && (a = a.edge),
            l.getObjectInfo(a,
            function(a) {
...
function() {
    ...
    this.ZoomWidget = function(b) {
        function e(a, c) {
            ...
            a = a || 0,
            c = c || .9;
            var d = Math.abs(ia.maxx[0][0][0] + ia.maxx[0][1] - ia.minx[0][0][0]),
            e = Math.abs(ia.maxy[0][0][1] + ia.maxy[0][2] - ia.miny[0][0][1]),
            g = b.width(s),
            h = b.height(s),
            i = g / ((d + 2 * a) / c),
            j = h / ((e + 2 * a) / c),
        ...
        na = function(a, b, c, d) {
            null == ja[a] && (ja[a] = [], ia.minx.push(ja[a]), ia.miny.push(ja[a]), ia.maxx.push(ja[a]), ia.maxy.push(ja[a])),
            ja[a][0] = b,
            ja[a][1] = c,
            ja[a][2] = d,
            ja[a][3] = a,
        ...
        va = function(a, c, d) {
            return function() {
                ua = d,
                b.addClass(ua, "jtk-surface-pan-active"),
                b.bind(document, "mouseup", wa),
                sa = window.setTimeout(function() {
                    b.bind(document, N, ya),
                    ta = window.setInterval(xa(a, c), qa)
                },
                pa)
            }
        },
        wa = function() {
            ...
            ua && b.removeClass(ua, "jtk-surface-pan-active"),
            ua = null
        },
        xa = function(a, b) {
            return function(c) {
        ...
        za = function(a, c, d, e, f) {
            ...
            return g.className = "jtk-surface-pan jtk-surface-pan-" + a,
            s.appendChild(g),
            b.bind(g, "click", oa(d, e)),
            b.bind(g, "mousedown", va(d, e, g)),
            g
        };
        H && (za("top", {
            left: "0px",
        ...
        Ka = function(a, b, c, d, f) {
            if (! (null == a || isNaN(a) || 0 > a)) {
                ...
                if ($ = a, f || t(Y, Z, $, o, b, c), null != g && g.setZoom(a), $a && $a.pan(), A) {
                    var p = Oa(q),
                    r = Na(p[0], p[1]); (r[0] != p[0] || r[1] != p[1]) && Oa(q, r[0], r[1], null, !d)
                }
                return $
            }
        },
        La = function(a, b, c, d) { - fa > b && (b = -fa),
            b > fa && (b = fa),
            Ma(i, b, -fa, fa, c, d)
        },
        ...
        Oa = function(a, c, d, e, f, g, h) {
            ...
            }) : (a.style.left = i[0] + "px", a.style.top = i[1] + "px", g && g(i)),
            i
        };
        q.style.left = "0px",
        q.style.top = "0px";
        ...
        Ra = {
            start: function(a, c) {
                if (!ba) {
                    ...
                    S && (d == q || d == s || d._jtkDecoration || g && g.owns(d) || V(d, a) === !0) && (da = !1, ga = -1, ha = -1, 3 !== a.which || b.enableWheelZoom === !1 || null != a.mozInputSource && 1 !== a.mozInputSource ? c.length <= 1 && (aa = !0, h = Ha(a), l = Oa(q)) : (ca = !0, h = Ha(a), Fa(a), l = Oa(q), i = $)),
                    v(a, m)
                }
            },
            move: function(a, b) {
        ...
        Ka($, null, !1, !1, !0),
        Ba(),
        this.positionChanged = function(a, c, d) {
            d = d || b.id(a);
            var e = c || Oa(a),
            f = b.width(a),
            g = b.height(a);
        ...
        this.remove = function(a) {
            ...
            for (var d in ia) if (ia.hasOwnProperty(d)) {
                for (var e = -1,
                f = 0; f < ia[d].length; f++) if (ia[d][f][3] === c) {
                    e = f;
                    break
                } - 1 != e && ia[d].splice(e, 1)
            }
        ...
        this.getBoundsInfo = e,
        this.zoomToFit = function(a) {
            a = a || {};
            var b = e(a.padding, a.fill);
            a.doNotZoomIfVisible && b.z > $ || Ka(b.z),
            m.centerContent({
                bounds: b,
        ...
        this.zoomToElements = function(a) {
            ...
            a.doNotZoomIfVisible && c.z > $ || Ka(c.z),
            m.centerContent({
                bounds: c,
                doNotAnimate: a.doNotAnimate !== !1,
                onComplete: a.onComplete,
        ...
        this.relayout = function(a, c) {
            if (b.enablePan === !1) {
                ...
                var d = a.w + (a.x < 0 ? a.x: 0) + I[0],
                e = a.h + (a.y < 0 ? a.y: 0) + I[1];
                q.style.width = d + "px",
                q.style.height = e + "px";
                var f = 0 == d ? 0 : (a.x - I[0]) / d * 100,
                g = 0 == e ? 0 : (a.y - I[1]) / e * 100;
        ...
        this.centerContent = function(a) {
            ...
            i = b.vh / 2 - f,
            j = Oa(q);
            Oa(q, a.horizontal !== !1 ? h - c[0] : j[0], a.vertical !== !1 ? i - c[1] : j[1], null, a.doNotAnimate,
            function() {
                a.doNotFirePanEvent || u(a.horizontal !== !1 ? h - j[0] : 0, a.vertical !== !1 ? i - j[1] : 0, $, $),
                g && g.pan(),
                $a && $a.pan(),
        ...
        this.setZoomRange = function(a, b) {
            return null != a && 2 == a.length && a[0] < a[1] && null != a[0] && null != a[1] && a[0] > 0 && a[1] > 0 && (ea = a, b || ($ < ea[0] || $ > ea[1]) && Ka($)),
            this
        },
        ...
        Za = function(a) {
            ...
            for (var c in Ya) if (Ya.hasOwnProperty(c)) {
        ...
        b.background && this.setBackground(b.background),
    ...
    b = function(a) {
        ...
        for (var e = function(c) {
            ...
            this.ensureLoaded = function(a, b, c, d) {
                for (var e = a; c >= e; e++) for (var g = b; d >= g; g++) null != f[e] && null != f[e][g] && (f[e][g][2] || (n(f[e][g][0], f[e][g][1], e, g), f[e][g][2] = !0))
            }
...
function() {
    ...
    c.Surface = function(a) {
        ...
        a = a || {};
        var n, o = d.getElement(a.container),
        p = c.createElement({
            position: h.relative,
            width: h.nominalSize,
        ...
        o),
        q = !(a.elementsDraggable === !1),
        r = a.elementsDroppable === !0,
        s = a.dragOptions || {},
        t = a.dropOptions || {},
        u = a.stateHandle,
        v = a.storePositionsInModel !== !1,
        w = a.modelLeftAttribute,
        x = a.modelTopAttribute,
        y = new ZoomWidget({
            viewport: o,
            canvas: p,
            ...
            events: {
                ...
                mousedown: function() {
                    jsPlumb.addClass(o, g.SURFACE_PANNING),
                    jsPlumb.addClass(document.body, g.SELECT_DEFEAT)
                },
                mouseup: function() {
                    jsPlumb.removeClass(o, g.SURFACE_PANNING),
                    jsPlumb.removeClass(document.body, g.SELECT_DEFEAT)
                }
            }
        }),
        z = [],
        A = a.lassoSelectionFilter,
        B = a.autoExitSelectMode !== !1,
        C = new b.Widgets.Lasso({
            on: function() {
                m.jsPlumb.on.apply(m.jsPlumb, arguments)
            },
            off: function() {
            ...
            onSelect: function(a, b, c, d) {
                var e = [],
                f = y.findIntersectingNodes(a, b, !c[0]);
                m.jsPlumb.clearDragSelection && m.jsPlumb.clearDragSelection(),
                m.toolkit.clearSelection(),
                d && z.length > 0 && m.toolkit.deselect(z);
                for (var g = 0; g < f.length; g++)(null == A || A(f[g].el.jtk.node) !== !1) && (e.push(f[g].el.jtk.node), m.jsPlumb.addToDragSelection && m.jsPlumb.addToDragSelection(f[g].el));
                z = e,
                m.toolkit.addToSelection(e, d)
            },
            onEnd: function() {
        ...
        l.bind(i.nodeRemoved,
        function(a) {
            y.remove(a.el)
        }),
        m.toolkit.bind(i.graphCleared,
        function() {
            y.reset()
        }),
        m.toolkit.bind(i.dataLoadStart,
        function() {
            y.setSuspendRendering(!0)
        }),
        m.toolkit.bind(i.dataLoadEnd,
        function() {
        ...
        jsPlumb.addClass(o, g.SURFACE),
        a.enablePan === !1 && jsPlumb.addClass(o, g.SURFACE_NO_PAN);
        var F = function(a, b) {
            var c = function(a) {
                var c = a.srcElement || a.target; (c == o || c == p) && l.fire(b, a)
            };
            m.jsPlumb.on(p, a, c),
            m.jsPlumb.on(o, a, c)
        };
        ...
        m.makeDraggable = function(a, b) {
            if (q) {
                ...
                function() {
                    ...
                    var a = p(arguments);
                    a.elementId = f,
                    a.pos = jsPlumb.getAbsolutePosition(c),
                    a.domEl = c,
                    jsPlumb.addClass(o, g.SURFACE_ELEMENT_DRAGGING),
                    l.fire(i.nodeMoveStart, a)
                }),
                j[k] = e.wrap(j[k],
                function(a) {
                    for (var b = function(a) {
                        y.positionChanged(a[0]),
                        jsPlumb.removeClass(o, g.SURFACE_ELEMENT_DRAGGING);
                        var b = {
                            el: a[0],
                            node: a[0].jtk.node,
                            pos: [a[1].left, a[1].top]
                        };
                        l.getLayout().setPosition(b.node.id, b.pos[0], b.pos[1], !0),
        ...
        m.makeDroppable = function(a, b) {
            if (r) {
                var c = d.getElement(a),
                f = (m.jsPlumb.getId(c), m.jsPlumb.extend({},
                t));
                null != b && m.jsPlumb.extend(f, b),
                f.drop = e.wrap(f.drop,
                function(a) {
                    var b = {
        ...
        var H = this.importNode = function(b, c) {
            ...
            b.style.left = d.left + h.px,
            b.style.top = d.top + h.px,
            jsPlumb.addClass(b, g.NODE),
            y.add(b, e, [d.left, d.top], !1),
            jsPlumb.isAlreadyDraggable(b) && m.makeDraggable(b),
            m.nodeMap[c] = b,
            m.reverseNodeMap[e] = b.jtk.node
        };
        this.zoomToFit = y.zoomToFit,
        this.zoomToFitIfNecessary = y.zoomToFitIfNecessary,
        this.zoomToSelection = function(a) {
            var b = m.toolkit.getSelection(),
            c = [];
        ...
        this.tracePath = function(a) {
            ...
            if (b.exists()) {
                for (var c = function(b, c) {
                    ...
                    j = b.path.previous[i],
                    k = !0,
                    l = b.path.path[h].edge;
                    null != j && (k = j === l.source),
                    e = m.getConnectionForEdge(l),
                    f = e.animateOverlay(a.overlay, jsPlumb.extend(a.options || {},
                    {
                        previous: f,
                        isFinal: h === g - 1,
                        forwards: k
                ...
                return d.length > 0 && (d[0].handler.bind(jsPlumbToolkit.Events.startOverlayAnimation,
                function() {
                    c(jsPlumbToolkit.Events.startOverlayAnimation, d[0].connection)
                }), d[d.length - 1].handler.bind(jsPlumbToolkit.Events.endOverlayAnimation,
                function() {
        ...
        for (var M = function(a) {
            m.jsPlumb.on(p, a, ".jtk-node, .jtk-node *",
            function(b) {
                var c = b.srcElement || b.target;
        ...
        N = 0; N < c.mouseEvents.length; N++) M(c.mouseEvents[N]);
        m.toolkit.bind(h.select,
        function(a) {
        ...
        m.toolkit.bind(i.selectionCleared,
        function() {
            m.jsPlumb.clearDragSelection && m.jsPlumb.clearDragSelection(),
            jsPlumb.removeClass(f("." + g.SURFACE_SELECTED_CONNECTION), g.SURFACE_SELECTED_CONNECTION),
            jsPlumb.removeClass(f("." + g.SURFACE_SELECTED_ELEMENT), g.SURFACE_SELECTED_ELEMENT)
        }),
        m.toolkit.bind(i.deselect,
        function(a) {
            if (a.obj.objectType == h.nodeType) {
                var b = m.getElement(a.obj.id);
        ...
        this.setAbsolutePosition = function(a, b, c) {
            ...
            d && d.id && l.getLayout().setPosition(d.id, b[0], b[1]),
            y.positionChanged(a, b),
            m.jsPlumb.revalidate(a),
            c && c()
        },
        this.setMode = function(a, b, c) {
            if (!D[a]) throw new TypeError("Surface: unknown mode '" + a + "'");
            E = a,
            D[a](),
        ...
        var R = function(a) {
            ...
            if (! (a && (a.droppables || a.source && a.selector || a.allowNative === !0))) throw new TypeError("Cannot configure droppables: you must specify either `droppables`, `source` + `selector` or `allowNative:true`");
            var c, f = a.dataGenerator ||
            function() {
                return {}
            },
            j = a.typeExtractor,
            ...
            n = a.droppables ? a.droppables: a.source ? a.source.querySelectorAll(a.selector) : [],
            p = a.dragOptions || {},
            q = a.dropOptions || {},
            r = "scope_" + (new Date).getTime(),
            s = function(b, c, d) {
                var e = !0;
            ...
            t = d.dragEvents[h.start],
            u = d.dragEvents[h.drag],
            v = d.dragEvents[h.stop],
            w = d.dragEvents[h.drop],
            x = function() {},
            z = a.nativeFilter || [],
            A = a.allowNative,
            B = {};
            if (p[t] = e.wrap(p[t], a.start || x), p[u] = e.wrap(p[u], a.drag || x), p[v] = e.wrap(p[v], a.stop || x), q.scope = r, q[w] = e.wrap(q[w], s), A) {
                ...
                for (C.style.position = h.absolute, c = 0; c < z.length; c++) B[z[c]] = !0;
                var D = function(a) {
                    return null != a.dataTransfer && 1 === a.dataTransfer.items.length ? 0 == z.length || B[a.dataTransfer.items[0].type] : !1
                };
                document.addEventListener(i.dragover,
                function(a) {
                    a.stopPropagation(),
                    a.preventDefault(),
                    D(a) && (jsPlumb.setAbsolutePosition(C, [a.pageX, a.pageY]), p[u].apply(null, [a, {
                        helper: C,
                        offset: {
                            left: a.pageX,
                            top: a.pageY
                ...
                !1),
                document.addEventListener(i.drop,
                function(a) {
                    a.stopPropagation(),
                    a.preventDefault(),
                ...
                !1),
                document.addEventListener(i.dragend,
                function(a) {})
            }
    ...
    c.Miniview = function(a) {
        function b(a) {
            if (o && y && !t) {
                ...
                y.applyZoomToElement(r, e);
                var f = [b[0] * e, b[1] * e];
                n = [c[0] - f[0], c[1] - f[1]],
                jsPlumb.setAbsolutePosition(r, n)
            }
        }
        function k(a) {
            if (null != y) {
                s = o.getBoundsInfo(),
                a = a || jsPlumb.getAbsolutePosition(r);
        ...
        D = function(a) {
            z = !0,
            A = y.pageLocation(a),
            B = jsPlumb.getAbsolutePosition(r),
            e.on(document, h.mouseup, F),
            e.on(document, h.mousemove, E),
            d.consume(a)
        },
        E = function(a) {
            if (C = !1, z) {
        ...
        F = function(a) {
            z = !1,
            A = null,
            e.off(document, h.mouseup, F),
            e.off(document, h.mousemove, E)
        },
        G = !0,
        H = function(a) {
            d.consume(a),
            o.nudgeWheelZoom(a.normalizedWheelDelta * x, a)
        };
        e.on(window, h.resize, jsPlumbToolkitUtil.debounce(function() {
            b()
        },
        100)),
        a.enableWheelZoom !== !1 && addWheelListener(p, H),
        y.setTransformOriginForElement(r, [0, 0]),
        jsPlumb.addClass(p, f.MINIVIEW),
        e.on(r, h.mousedown, D),
        u && (v = jsPlumb.createElement("div"), v.className = f.MINIVIEW_COLLAPSE, p.appendChild(v), e.on(v, g.click,
        function(a) {
            w = !w,
            jsPlumb[w ? j.addClass: j.removeClass](p, f.MINIVIEW_COLLAPSED)
        }));
        var I = function(a) {
            y.zoomToFit({
                onComplete: b,
        ...
        var J = function(a) {
            s = a.bounds,
            y.positionChanged(a.el, a.pos),
            jsPlumb.setAbsolutePosition(l.nodeMap[a.node.id], a.pos),
            I(!0),
        ...
        K = function(a) {
            ...
            h.relatedElement = a.el,
            s = o.getBoundsInfo(),
            h.setAttribute(i.jtkNodeId, a.node.id),
            h.setAttribute(i.relatedNodeId, a.el.getAttribute(g.id)),
            q.appendChild(h),
            y.add(h),
            l.nodeMap[a.node.id] = h,
            m.getLayout().map(a.node.id, h),
            b()
        };
        ...
        var O = function(a) {
            var c = a.node,
            d = l.nodeMap[c];
            d && (y.remove(d), delete l.nodeMap[c], l.jsPlumb.removeElement(d)),
        ...
        o.bind(h.pan, b),
        o.bind(h.zoom, b),
        o.bind(h.nodeMoveEnd, J),
        o.bind(h.nodeRemoved, O),
        o.bind(h.nodeAdded, K),
        o.bind(h.nodeRendered, K),
        o.bind(h.relayout, b),
        o.bind(h.objectRepainted, N),
        o.bind(h.stateRestored, b),
        a.toolkit.bind(h.graphCleared, P);
        var Q = function() {
            I(!0)
        };
        m.getLayout().bind(h.redraw, Q),
        this.setHostLayout = function(a) {
            var b = m.getLayout();
            b && b.setHostLayout(a)
        },
        this.setZoom = y.setZoom,
        this.getZoom = y.getZoom,
        this.getTransformOrigin = y.getTransformOrigin
    }
}.call(this),
...
function() {
    ...
    c.Lasso = function(a) {
        ...
        u = function(a, c) {
            ...
            } else jsPlumb.setAbsolutePosition(b, a),
            i(b, c)
        },
        v = function(a) {
            var c = a ? "block": "none";
            t ? (m.top.style.display = c, m.left.style.display = c, m.right.style.display = c, m.bottom.style.display = c) : b.style.display = c,
...
function() {
    ...
    A = function(a) {
        if (a.id && o[a.id]) {
            ...
            v(),
            l.innerHTML = a.labels ? a.labels.ok || p.ok: p.ok,
            m.innerHTML = a.labels ? a.labels.cancel || p.cancel: p.cancel,
            q = z(a.container);
            var C = a.data || {},
            D = s.template(a.id, C);
            d.innerHTML = a.title || o[a.id].title || "",
            e.innerHTML = "";
            for (var E = D.childNodes.length,
            G = 0; E > G; G++) e.appendChild(D.childNodes[0]);
            q.appendChild(b),
            q.appendChild(c),
            jsPlumb.addClass(c, n),
            jsPlumb.addClass(c, A),
            b.style.display = "block",
            c.style.display = "block",
            c.setAttribute("data-position", f),
            c.setAttribute("data-axis", w),
            m.style.visibility = o[a.id].cancelable ? "visible": "hidden",
            r = !0,
            x();
            if (C.conditions !== undefined) {
            // if (a.data.hasOwnProperty('conditions')) {
                $.each(a.data.conditions, function(key, value) {
                    if (key > 0) {
                        add();
                    }
                })
            ...
            t.onOpen && t.onOpen(c),
            i && i(c),
            jsPlumb.addClass(c, "jtk-dialog-overlay-visible"),
            jsPlumb.on(document, "keyup", y),
            u && (jsPlumb.on(window, "resize", x), jsPlumb.on(window, "scroll", x)),
            jsPlumb.on(c, "click", "[jtk-clear]",
            function(a) {
                var b = this.getAttribute("jtk-att");
                b && F(c.querySelectorAll("[jtk-att='" + b + "']:not([jtk-clear])"), this)
            }),
            jsPlumb.on(c, "click", "[jtk-clear-all]",
            function(a) {
    ...
    B = function(a) {
        for (var b = e.querySelectorAll("[jtk-att]"), c = 0; c < b.length; c++) {
            ...
            h = s.data(a, g);
            null != h && C[f](b[c], h),
            b[c].getAttribute("jtk-commit") && ("INPUT" === d ? jsPlumb.on(b[c], "keyup",
            function(a) { (10 == a.keyCode || 13 == a.keyCode) && I()
            }) : "TEXTAREA" === d && jsPlumb.on(b[c], "keyup",
            function(a) { ! a.ctrlKey || 10 != a.keyCode && 13 != a.keyCode || I()
            }))
        }
    },
    C = {
    ...
    G = function() {
        for (var a = e.querySelectorAll("[jtk-att]"), b = {},
        c = 0; c < a.length; c++) {
            var d = a[c].tagName.toUpperCase(),
    ...
    n.jsPlumbToolkit.Dialogs = {
        initialize: function(a) {
            ...
            a.labels && jsPlumb.extend(p, a.labels),
            a.globals && jsPlumb.extend(t, a.globals)
        },
        show: A,
        hide: function() {
            I(!0)
    ...
    a.jsPlumbToolkit.DrawingTools = function(a) {
        ...
        y = {
            ...
            br: function(a, b) {
                ...
                e = g,
                f = i;
                return 0 >= c && (e = g + c, c *= -1),
                0 >= d && (f += d, d *= -1),
                x(e, f, c, d)
            }
        };
        l.bind("selectionCleared",
        function() {
            s()
        }),
        l.bind("select",
        ...
        m.on(document, "mousedown", ".jtk-draw-handle",
        function(a) {
